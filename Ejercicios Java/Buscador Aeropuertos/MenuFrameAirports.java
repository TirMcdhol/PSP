...
public class MenuFrameAirports extends JFrame {
	...
	public MenuFrameAirports() {
		...
		ImageIcon imagen2 = new ImageIcon(getClass().getResource("/ejercicio4Airports/airportMenu.jpg")); 
		JLabel lblImagen = new JLabel();
		lblImagen.setIcon(imagen2);
		lblImagen.setBounds(10,11,574,239);
		...
		btnMap.setBounds(138, 316, 307, 33);
		...
		tfNombreAeropuerto.setBounds(269, 258, 300, 23);
		...
		tfAeropuertoEscogido.setBounds(169, 282, 401, 23);
